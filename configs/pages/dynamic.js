export const pages = [
  {
    ...
    features: {
      title1: "Distribution",
      title2: "Simplified",
      description: "List on Filmhub to take control of your film's distribution and monetization strategy.",
      list: [
        {
          title: "Maintain Your Rights",
          description: "You own your titles and can set their availability to channels, territories, and rights. ",
        },
        {
        ...
        {
          title: "Eliminate Upfront Risk",
          description: "There are no fees or upfront costs: just an 80-20 revenue share once streaming channels order your listed titles.",
        },
        {
          title: "Share Our Access",
          description: "We've negotiated non-exclusive revenue-share deals with channel partners, so you get access only available to large distributors.",
        },
        {
  ...
  },
  {
    ...
    channelBuyers: {
      ...
      comments: [
        {
          comment: "Rather than taking hours to find LGBTQ+ content for our Pride Month selections, I was able to find and license titles within minutes.",
          author: "Lloyd Scott",
          role: "Head of Content, Plex",
          img: "plex.png",
        },
        {
          comment: "Filmhub’s technology platform for discovery, licensing, and deliveries have made the lives of our editorial and operations teams 10X easier.",
          author: "Rebecca Wan",
          role: "Senior Manager of Content Licensing, TCL",
          img: "tcl.png",
        },
      ],
    },
    columns: {
      title: "Licensing Simplified",
      list: [
        {
        ...
        {
          title: "Ridiculously efficient browsing and selection",
          description: "Powerful search filters and data-driven recs tailored to your discovery requirements, with all promo materials ready to download.",
          img: "icn-2.svg"
        },
        {
    ...
    howItWorks: {
      ...
      posters: [
        ...
        { name: "Soccer Films", img: "p9.png", alt: "Funke!", color: "#f25959" },
        ...
        { name: "Neo-Noir", img: "p13.png", alt: "Motif", color: "#3ec2dd" },
        { name: "Soccer Films", img: "p14.png", alt: "Offside", color: "#f25959" },
        { name: "Summertime", img: "p15.jpg", alt: "Summertime in New York", color: "#68abff" },
        { name: "AAPI Filmmakers", img: "p16.png", alt: "The Crumbles", color: "#24c7ae" },
        ...
        { name: "Neo-Noir", img: "p20.png", alt: "Why Siegfried Teitelbaum Had To Die", color: "#ac9f92" },
